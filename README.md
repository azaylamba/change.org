...
You have to design & build the backend for the application and the ability for the users to register, find, sign petitions etc.
...
https://github.com/azaylamba/change.org 
